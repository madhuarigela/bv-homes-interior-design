            ...
            <div className="mb-8 p-6 bg-warm rounded-sm animate-fade-in">
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className={`px-4 py-2 rounded-sm text-xs tracking-wider uppercase transition-colors ${
                    !selectedCategory ? "bg-primary text-primary-foreground" : "bg-background border border-border hover:bg-warm-dark"
                  }`}
                >
                  All
                </button>
                {categories.map((cat) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-sm text-xs tracking-wider uppercase transition-colors ${
                      selectedCategory === cat.slug ? "bg-primary text-primary-foreground" : "bg-background border border-border hover:bg-warm-dark"
                    }`}
                  >
                    {cat.name}
                  </button>
              ...
              >
                ...
                <div className="flex items-center gap-1 mb-1">
                  {Array.from({ length: 5 }).map((_, i) => (
                    <Star key={i} className={`w-2.5 h-2.5 ${i < Math.floor(product.rating) ? "fill-accent text-accent" : "text-border"}`} />
                  ))}
