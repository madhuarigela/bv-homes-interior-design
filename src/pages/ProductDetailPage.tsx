...
const ProductDetailPage = () => {
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <main className="pt-32 pb-20 px-6 text-center">
          ...
          <a href="/shop" className="text-accent underline">
            Back to Shop
          </a>
        </main>
        <Footer />
  ...
  const openWhatsApp = () => {
    ...
    const message =
      `Hi BV Homes, I'm interested in this product.\n\n${details}\n\nPlease share the current price, availability, delivery details and any other information. Thank you.`;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-xs text-muted-foreground text-center mt-3">
                Ask about price, availability, delivery and product details directly on WhatsApp.
              </p>
            </div>
          </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                {related.map((item) => (
                  ...
                  >
                    ...
                    <h3 className="font-display text-sm font-medium group-hover:text-accent transition-colors">
                      {item.name}
                    </h3>
                  </a>
                ))}
